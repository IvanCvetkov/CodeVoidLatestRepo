...
{
    /// <summary>
    /// Interaction logic for CSharpIntro.xaml
    /// </summary>
    public partial class CSharpIntro : Page
    {
        public CSharpIntro()
        {
            InitializeComponent();
        ...
        private void NextTutorial_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            this.NavigationService.Navigate(new Uri("Pages/LangPages/CSharp/Content/IntroToCSharp/CSharpEnd.xaml", UriKind.Relative));
        }
