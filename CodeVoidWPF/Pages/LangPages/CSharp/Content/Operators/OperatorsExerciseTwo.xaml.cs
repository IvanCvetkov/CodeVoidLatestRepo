...
{
    /// <summary>
    /// Interaction logic for OperatorsExerciseTwo.xaml
    /// </summary>
    public partial class OperatorsExerciseTwo : Page
    {
        public OperatorsExerciseTwo()
        {
            InitializeComponent();
        }
        ...
        {
            this.NavigationService.Navigate(new Uri("Pages/LangPages/CSharp/Content/Operators/OperatorsExercise.xaml", UriKind.Relative));
        }
