...
{
    /// <summary>
    /// Interaction logic for DoWhileTwo.xaml
    /// </summary>
    public partial class DoWhileTwo : Page
    {
        public DoWhileTwo()
        {
            InitializeComponent();
        ...
        static DoWhileTwo()
        {
            string[] blueWords = { "string", "char", "null", "while", "do", "namespace", "class", "using", "public", "static", "void", "int" };
            string[] greenWords = { "Console", "Path" };
            string[] yellowWords = { "ReadKey", "WriteLine", "ReadLine", "Write" };
